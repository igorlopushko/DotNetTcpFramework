...
namespace TCP.Framework.Core.Communication.Protocols.BinarySerialization
{
    ...
    /// 
    /// This class can be derived to change serializer (default: BinaryFormatter). 
    /// To do this SerializeMessage() and DeserializeMessage() methods must be overrided.
    /// </summary>
    public class BinarySerializationProtocol : IWireProtocol
    {
        ...
        #region IWireProtocol implementation
        ...
        public byte[] GetBytes(IMessage message)
        {
            ...
            if (messageLength > MaxMessageLength)
            {
                throw new CommunicationException(
                    string.Format("Message is too big ({0} bytes). Max allowed length is {1} bytes.",
        ...
        public IEnumerable<IMessage> CreateMessages(byte[] receivedBytes)
        {
            ...
            while (this.ReadSingleMessage(messages)) { }
            //Return message list
            return messages;
        }
        ...
        /// <summary>
        /// This method is used to serialize a IMessage to a byte array.
        ...
        /// <summary>
        /// This method is used to deserialize a IMessage from it's bytes.
        ...
        protected virtual IMessage DeserializeMessage(byte[] bytes)
        {
            ...
            using (var deserializeMemoryStream = new MemoryStream(bytes))
            {
                ...
                return (IMessage) binaryFormatter.Deserialize(deserializeMemoryStream);
            }
        }
